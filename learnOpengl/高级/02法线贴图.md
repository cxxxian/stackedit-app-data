...
```
在`geometry.cpp`中实现如下，其他的都和原来一样，只是jia
```cpp
Geometry::Geometry(
	const std::vector<float>& positions,
	const std::vector<float>& normals,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUwNTMxMDQ4OSwxMDg5MDU0MjYzLC0xND
UyNTEwNjU0LDEzMjU1NjczMDgsLTE3ODgyMzg2NSwxNTk0ODA1
MTcsLTEyNzY5ODgxNTEsLTUyMDQ4Mzk2LDE1NjIxNzI5NDIsLT
Y4MDY2ODM4MCwxNTQwODkwOTMzLDgwMTQxNDQyMF19
-->