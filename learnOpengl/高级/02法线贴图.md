...
所以我们直接使用`tangents.resize(positions.size())`进行数组大小声明，这句话的意思就是在`tangents`数组中放入全是`0`的元素，大小和`positions`一样
```cpp
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyNzU4OTA3MSwyMTgzMzU5NTAsMTM1MD
U2OTI1NSwyMDY2OTI0ODU4LDE3ODM2NzI1OTcsMjEzODk1ODQ3
LDIxMDYwMzQ2MDUsMTMyMzk5ODk0MCwtMTMyNDYxMDMwNCwxMD
