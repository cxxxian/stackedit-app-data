...
Renderer::Renderer() {
	...
	mPhongNormalShader = new Shader("assets/shaders/phongNormal.vert", "assets/shaders/phongNormal.frag");
}
```
到`pickShader`方法中完善
```cpp
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzY5ODgxNTEsLTUyMDQ4Mzk2LDE1Nj
IxNzI5NDIsLTY4MDY2ODM4MCwxNTQwODkwOTMzLDgwMTQxNDQy
MF19
-->