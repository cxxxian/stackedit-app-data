...
所以为了避免每次添加都要重新开辟数组空间（因为我们声明的tangents``）
```cpp
std::vector<GLfloat> tangents{};
tangents.resize(positions.size());
```
### 1.1计算每个三角面的切线
### 1.2对当前三角面的每个顶点法线对T进行正交化
### 1.3正交化后的T累加到对应顶点的T属性

## 2.实验

<!--stackedit_data:
eyJoaXN0b3J5IjpbNzk2NjY0MTUwLDIxODMzNTk1MCwxMzUwNT
Y5MjU1LDIwNjY5MjQ4NTgsMTc4MzY3MjU5NywyMTM4OTU4NDcs
MjEwNjAzNDYwNSwxMzIzOTk4OTQwLC0xMzI0NjEwMzA0LDEwOD
kwNTQyNjMsLTE0NTI1MTA2NTQsMTMyNTU2NzMwOCwtMTc4ODIz
ODY1LDE1OTQ4MDUxNywtMTI3Njk4ODE1MSwtNTIwNDgzOTYsMT
U2MjE3Mjk0MiwtNjgwNjY4MzgwLDE1NDA4OTA5MzMsODAxNDE0
NDIwXX0=
-->