...
利用玩家的摄像机的投影矩阵和视角矩阵，将子视锥体的`ndc`转到世界空间坐标系下面，然后我们把子视锥体的八个点求中点作为光源位置，在那个位置建立正交相机，我们就可以把子视锥体转到光源坐标系下面，得到`lightMatrix`
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2ODA1NDg0OSwyMDI3MTQ4MDg4LDQ0MT
U3NzQwMywxNjMwMzU5NDA0LDEyNjc2Njk2MiwxNTcyODcyNjI4
LDE2MjE2NjQ2NTEsODU3ODUzMDUxLC0xNTQwMTczNzEyLDExMD
