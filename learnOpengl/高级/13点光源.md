...
```
然后我们要去修改一下`createBox`函数，因为我们现在要从里面往外看
```cpp
static Geometry* createBox(float size, bool invNormal = false);
```
默认是false的，如果shi
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjU4MDE3MTEzLDU3NjYwMjg3LC03NjE4MT
M3MDYsMTQ5OTIxMjM2MCwxNTc0MzI1OTk1LC0xMTkxNDEwMjMs
MTkxMTY4NTE2OSwtMTk4NzAyNzU0OCw1NjY3NzMwODIsNTA0Mz
k2OTY4LC0xMzg1NjM5NTksLTM1ODY3OTYxMCwzNTY5NDEzNjUs
ODU5ODE4NDU3LC01MTI2NDYxMzAsLTIwODg3NDY2MTIsLTIwOD
g3NDY2MTJdfQ==
-->