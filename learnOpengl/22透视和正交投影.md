...
```
### 非NDC数据
所以我们有了view和ortho矩阵，我们就可以将原本的三角形的数据修改为非EDC的形式
```
	//原来的
	/*float positions[] = {
        -0.5f, -0.5f, 0.0f,
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjMwMDc5OTc5LC0zNDIyNDUyOSw5Mzk0Nj
U2OTMsLTE5OTc1MTg2OTksODkzMzI4MzEsLTE1NjM4MTUwMjMs
MTE5OTkxMTExOCw2MTc3NTE1NzgsMTU4NzAzNDYzNSwxMjY5OT
gwMzkxXX0=
-->