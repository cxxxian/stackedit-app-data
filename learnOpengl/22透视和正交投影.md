...
注意此处，NDC的z轴和摄像头的z轴相反，是为了让眼前的z成为正值，`f-n`的值作为缩放系数，所以NDC坐标系是左手坐标系，OpenGL的世界坐标系为右手
```
void prepareOrtho() {
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTg3MDE1MTE5LDkzOTQ2NTY5MywtMTk5Nz
UxODY5OSw4OTMzMjgzMSwtMTU2MzgxNTAyMywxMTk5OTExMTE4
LDYxNzc1MTU3OCwxNTg3MDM0NjM1LDEyNjk5ODAzOTFdfQ==
-->