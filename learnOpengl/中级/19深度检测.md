...
### ！！！
解释一下就是我们每一帧绘制时都默认将深度测试以及深度缓存打开，然后再针对每一个物体单独地进行设置`bool`值
```cpp
void Renderer::render(
	Scene* scene, 
	Camera* camera,
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNTM0NDc4NywyMDUwMzc2MDc1LC0yMD
g1MzczMTc3LDY0NTQyMzU1NSw4NjU2MDc3MTcsMjAwMzM4ODcx
NSwtMjE4OTgwNDE4LC0xODA5OTE4OTgzLDExMDYwMDUwNjksLT
I2OTIwMzAyMywyMTczNjQ0NjEsNTkwMjgxMzkyLC0yMTE5NDY4
NDQsLTIwODg3NDY2MTJdfQ==
-->