...
我们希望做到，不将B的深度信息写入深度缓存，这样的话，A在最前面，B按照深度信息进行绘制，但是不会更新深度缓存中的深度值，这样C绘制时，根据深度信息会将B给遮盖住（即是是C的深度比B深的情况下）

![输入图片说明](/imgs/2025-02-07/yRnKTj4Lxmcw9MpW.png)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTk5MDE3NzgsLTE4MDk5MTg5ODMsMT
EwNjAwNTA2OSwtMjY5MjAzMDIzLDIxNzM2NDQ2MSw1OTAyODEz
OTIsLTIxMTk0Njg0NCwtMjA4ODc0NjYxMl19
-->