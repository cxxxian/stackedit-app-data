...
```
在renderObject方法中，我们针对每一个物体单独地去设置渲染状态（即深度相关的变量）
```cpp
//针对单个object进行渲染
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ1NDIzNTU1LDg2NTYwNzcxNywyMDAzMz
g4NzE1LC0yMTg5ODA0MTgsLTE4MDk5MTg5ODMsMTEwNjAwNTA2
OSwtMjY5MjAzMDIzLDIxNzM2NDQ2MSw1OTAyODEzOTIsLTIxMT
