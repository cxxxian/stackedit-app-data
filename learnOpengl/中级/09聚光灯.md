...
{
	...
		shader->setFloat("innerLine", glm::radians(spotLight->mInnerAngle));
		shader->setFloat("outerLine", glm::radians(spotLight->mOuterAngle));
	...
	}
}
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzI1MDAxODUsMTc4NjE2MDM4MSwzMD
k4NzEzMTksLTE5MjE0NjkxMDUsMTY2MzY1MDczNywtMjA1MTcy
NzU4NCwtMTQ3NTEyNTk1MV19
-->