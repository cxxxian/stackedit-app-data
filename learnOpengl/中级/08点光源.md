...
```
最后在`render`函数中，补充`case`为`WhiteMaterial`的情况，根据我们的`white.vert`，只有`mvp`矩阵需要传入，`fragment`没什么要传的
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDkyMDgzMDAzLC05NTE5MjYxMzMsMTYzND
cxMTIsLTE3MzQ3NTEyNDMsLTIwMTY3OTQ1NzIsLTEzODg5MTcx
ODJdfQ==
-->