...
```
**attention**：这里要注意，我们也要同时绑定`mDiffuse`和`mSpecularMask`，因为我们的PhongMaterial默认我们绑定了这两个材质，如果没有给mSpecularMask赋值的话，我们会报bind的空指针错误，本质上就是因为在bind的时候没有mSpecularMask	
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4MTMwNDQ4NywtMTQ0NzI3MTA3MCwzNT
M4NDQ5NzgsODIyNDI4ODYzLC0xMzA5NTk4NDk5LDM3NTUwMjUy
MSwtMzYxODAzMTQxLDE1ODA3MDc4OSwxMDQ5Nzk1ODMwLDU0NT
cyOTc1MSwtMTk2MDg1ODQxNywxNjQ0NzMxMjU4LDE0NDMzMTk2
NDcsNjQzMDE2OTA1XX0=
-->