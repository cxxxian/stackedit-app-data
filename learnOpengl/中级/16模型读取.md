...
Object* AssimpLoader::load(const std::string& path)
{
	...
	aiScene* scene = importer.ReadFile(path, aiProcess_Triangulate | aiProcess_GenNormals);
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTE5OTc0MDQ2LDE1ODA3MDc4OSwxMDQ5Nz
k1ODMwLDU0NTcyOTc1MSwtMTk2MDg1ODQxNywxNjQ0NzMxMjU4
LDE0NDMzMTk2NDcsNjQzMDE2OTA1XX0=
-->