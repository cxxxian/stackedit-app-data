...
开始实现：
在`vertexShader`中我们声明一个`worldPosition并传给fragmentShader，worldPosition就是worldPosition = transformPosition.xyz，
```
#version 460 core
...
void main()
{
    ...
    transformPosition = (modelMatrix * transformPosition).xyz;
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTg3NzI3NTAsMTM0MTI3ODEyOCwtMT
UyOTA0NDUxN119
-->