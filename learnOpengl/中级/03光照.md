...
在fragmentShader中，引入step函数用来判断
dotResult用来计算逆向光线与法线的夹角cos值，如果小于零才说明neng
```
void main()
{
    //计算光照的通用数据
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDU0MjE0MTgsLTU5NTYyMTA1OSwtMT
c2NzAxNTAwNywxMDExODI2NjY1LDY4NzA1NzI1NywyNzUxODI5
NjgsLTE2ODQ1OTU1MTgsMTM0MTI3ODEyOCwtMTUyOTA0NDUxN1
19
-->