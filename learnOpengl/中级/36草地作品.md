...
```
但是会发现草地贴图并没有跟着运动，这是因为在`frag`中我们使用地是位置信息作为`uv`采样，此时我们直接针对`transformPosition.x`进行操作，然后又把`worldPosition = transformPosition.xyz`赋值，那么肯定会影响到贴图的`uv`采样
### 7.1加入风力的强度控制
### 7.2加入风力的相位控制
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3NDY4MDg0LDUyNTczNzQ1OCwtMTUwND
Q2NTc5NSwzNzE4MDI4ODIsLTE5NzMyMTk0MTgsLTY0NzExMTM2
Niw3NjQyNzg4NzAsMTIwODQwMjUxNCw2NTgzMTM2NjUsLTE5Mj
Q3OTE0NTEsMjA5NjI1MTY1MCwtMjAyNzY5MDUxNCwxMTk0NTk3
NDUwLDY1NjM1MzQ2Niw3NDQ1OTA4MTEsLTQ3MDEwMzE0MywtMz
gzNDAyOTYyLDMzNTYyNDI5NCw4MjUyMjc4NzgsMTg5MDAyOTk2
NV19
-->