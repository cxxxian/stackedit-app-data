...
### 开始实操
设置一个prepareState函数用来开启glEnable深度检测 和 glDepthFunc设置深度检测
```
void prepareState() {
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjc2Nzg2MDMsMTMwNzUxNzQzMiw4Nz
g0NjQwMjksOTgzMTIzMDg4LDkxMDI4NzczMiwtNTk3NTkyODMz
LC0xNzM5Mjk5NjkwLC0yMDg4NzQ2NjEyXX0=
-->