...
然后我们就可以在画板蓝图中，更新一些值
首先是创建`translate`材质的实例，这样我们就可以把它的`Offset`赋值，这里就是把`Position - LastPosition`，然后我们再`/ Size`，这样的话就可以映射到`uv`大小了，然后更新

![输入图片说明](/imgs/2026-09-19/ye5FoJiUuZK1NzQU.png)

![输入图片说明](/imgs/2026-09-19/e0iKwIZjCPn6ZKIx.png)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NzA1OTc2NywtMTgzNzMyNzY0MiwtOD
