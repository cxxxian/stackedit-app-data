...
```
数学公式：
Σscreen=JT Σ3D JΣ_{screen} = J^T \, Σ_{3D} \, JΣscreen​=JTΣ3D​J
    -   `cov3D` 是相机空间下的椭球协方差
...
-   `a`, `d`, `b` 是协方差矩阵的分量：
    ...
    Σ2D=(abbd)Σ_{2D} = \begin{pmatrix} a & b \\ b & d \end{pmatrix}Σ2D​=(ab​bd​)
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUxNjA4MjQxOCwtODY4NzU5NDI3XX0=
-->