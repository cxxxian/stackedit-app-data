...
-   通过旋转矩阵 RRR 和缩放矩阵 SSS，你可以把这个球变成任意方向、任意长短轴的**3D 椭球**。
    
-   这个形状信息数学上就是 3D 协方差矩阵 Σ3D\Sigma_{3D}Σ3D​。
...
-   用 JJJ 把 3D 协方差“挤压”到屏幕上，就能得到**屏幕上的 2D 椭圆形状**。
    

公式：

Σ2D=J Σ3D JT\Sigma_{2D} = J \, \Sigma_{3D} \, J^TΣ2D​=JΣ3D​JT
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1NzA1NzE4OSwxNDYyNTQzMTI4LC04Nj
g3NTk0MjddfQ==
-->