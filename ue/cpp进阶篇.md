...
# 新敌人Raptor
用我们做的模板进行动画蓝图创建，为其赋上死亡和混合空间播放器（IdleWalkRun）

![输入图片说明](/imgs/2024-11-23/PEKRv9tZVWvxqIrG.png)

都是重复性的操作，以`BP_BaseEnemy`创建子类蓝图叫`BP_Raptor`
修改胶囊体大小，速度，拖到场景中，设置巡逻点，就可以做到巡逻功能了
但是以下功能得创建新蒙太奇，无法复用以前的动画
...
制作蒙太奇以及动画蓝图中相应的通知的调用

![输入图片说明](/imgs/2024-11-23/FPwhoJFH3oSopyLk.png)

**RotationWarp一定要记得改成facing！！！**

![输入图片说明](/imgs/2024-11-23/26EN48pXuVqp4v8M.png)

最后将蒙太奇挂到`Raptor`蓝图中即可
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzNzk4MTc3OCwtMTU3OTQ2NDE4NCwxMD
k4MDk2OTYsNzE2NzY4NzI2LDE2MDM3NTM4MDEsMTE2MTEyMDQ2
MywxNDM0Nzc3NDkwLDEzODM4ODE5MSwxOTg3MTg1ODA5LC0yMz
U2MDAxMiwtMjAxMTc2MzYwLC0xNzYzODYxODkwLDIxMTI4Mzcz
NTcsNDIwNjE0MTQ5LC00NTMzNDUzOTksMTczNzA0NDM4OSwxMT
M5NjE0MzEsLTI3NTc1OTU1MCwtMTkxMzMxMTA3MiwxNzIxMDk3
NTQ0XX0=
-->