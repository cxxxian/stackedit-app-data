...
#include <string>
struct TextureData {     
	std::string name;                     // 用于识别（路径或 ID）     std::vector<unsigned char> pixels;   // 像素数据     int width = 0;     int height = 0;     int channels = 4;                    // 通常是 RGBA };`
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNTQxMzEwMiwzMDk1Nzk3MjgsMTY1MD
